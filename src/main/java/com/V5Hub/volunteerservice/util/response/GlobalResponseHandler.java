...
//避免重复处理已经做过封装处理的返回值
        ...
        boolean flag=!"com.V5Hub.volunteerservice.util.response.Result".equals(returnTypeName)
    ...
    public Object beforeBodyWrite(Object o,
        ...
        if("com.V5Hub.volunteerservice.util.response.Result".equals(returnTypeName)){
            return o;
        }
        /*
